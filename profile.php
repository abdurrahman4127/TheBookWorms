...
<body background="pictures/home.png">
  ...
  <form action="action_profile.php" enctype="multipart/form-data" method="POST">
    <h2 class="headspace font infospace"> Account Information
      <hr class="hr" style="border-bottom: 4px solid #2d70d5;">
    </h2>
    ...
    <table class="table" style="border-collapse: collapse; font: 12px YU Gothic UI;" border="1" cellspacing="5" cellpadding="5">
      <tbody style="box-shadow: 1px 1.732px 10px 0px rgb( 45, 112, 213);">
        <tr>
          <td>
    ...
    <h2 class="headspace2 font infospace"> Personal Information
      <hr class="hr" style="border-bottom: 4px solid #2d70d5;">
    </h2>
  ...
  <h2 class="headspace3 font infospace"> Close Account
    <hr class="hr" style="border-bottom: 4px solid #2d70d5;">
  </h2>
