...
?>  --- <?php $today="$day-$month-$day1-$year";
 ...
 echo $nextday;?></p>
           ...
           <p class="price">Taka <?php echo $price;?> <br><br><br><br><br>Subtotal Taka<?php echo $price;?><br> Shipping Fee: Free<br><br></p>

           <p class="total">Total(Tax included) Taka <?php echo $price;?></p>
