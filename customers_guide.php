...
<link rel="stylesheet" href="css_files/artists_guide.css">
<!-- <style type="text/css">
    .head-artists {
        font-size: 30px;
...
<body class="guide-background">
    ...
    <h2 class="head-guide">Guide</h2><br>
    <hr class="hr" style="border-bottom: 2px solid #000000;">
    </p>
    ...
    <p class="word2">Rainbow exhibits original artworks created by new and established artists from Albay.</p>
    ...
    <h3 class="word1">Where is Rainbow based?</h3>
